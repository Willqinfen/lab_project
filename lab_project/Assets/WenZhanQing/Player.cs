...
public class Player : MonoBehaviour
{
    ...
    private void Adjust()
    {
        ...
        {
            float angle = Vector3.Angle(newdest - initial_position, new Vector3(initial_position.x + 2, initial_position.y, initial_position.z));
            newdest = new Vector3(radius * Mathf.Cos(angle), newdest.y, radius * Mathf.Sin(angle));
            Is_AdjustNext = true;
        }
    }
